...
import type {
  V2Keep3rPublicJob,
  V2Keep3rPublicJobInterface,
} from "../V2Keep3rPublicJob";
...
export class V2Keep3rPublicJob__factory {
  static readonly abi = _abi;
  static createInterface(): V2Keep3rPublicJobInterface {
    return new utils.Interface(_abi) as V2Keep3rPublicJobInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): V2Keep3rPublicJob {
    return new Contract(address, _abi, signerOrProvider) as V2Keep3rPublicJob;
  }
}
