...
} from "../BaseStrategyInitializable";
...
export class BaseStrategyInitializable__factory {
  static readonly abi = _abi;
  static createInterface(): BaseStrategyInitializableInterface {
    return new utils.Interface(_abi) as BaseStrategyInitializableInterface;
  }
  static connect(
    address: string,
