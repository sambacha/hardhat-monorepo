...
export interface TendV2Keep3rJobInterface extends utils.Interface {
  functions: {
...
export interface TendV2Keep3rJob extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TendV2Keep3rJobInterface;
