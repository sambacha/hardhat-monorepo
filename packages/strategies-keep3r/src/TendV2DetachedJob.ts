...
export interface TendV2DetachedJobInterface extends utils.Interface {
  functions: {
...
export interface TendV2DetachedJob extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TendV2DetachedJobInterface;
