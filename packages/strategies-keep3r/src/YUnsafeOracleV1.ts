...
export interface YUnsafeOracleV1Interface extends utils.Interface {
  functions: {
...
export interface YUnsafeOracleV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: YUnsafeOracleV1Interface;
  ...
  functions: {
    ...
    pairOracle(arg0: string, overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    pairOracle(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
