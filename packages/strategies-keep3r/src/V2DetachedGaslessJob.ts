...
export interface V2DetachedGaslessJobInterface extends utils.Interface {
  functions: {
...
export interface V2DetachedGaslessJob extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: V2DetachedGaslessJobInterface;
