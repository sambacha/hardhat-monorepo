...
import type {
  ...
  V2QueueKeep3rStealthJobInterface,
} from "../V2QueueKeep3rStealthJob";
...
export class V2QueueKeep3rStealthJob__factory {
  static readonly abi = _abi;
  static createInterface(): V2QueueKeep3rStealthJobInterface {
    return new utils.Interface(_abi) as V2QueueKeep3rStealthJobInterface;
  }
  static connect(
    address: string,
