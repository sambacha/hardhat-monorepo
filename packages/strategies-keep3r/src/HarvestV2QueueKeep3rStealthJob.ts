...
export interface HarvestV2QueueKeep3rStealthJobInterface
...
export interface HarvestV2QueueKeep3rStealthJob extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HarvestV2QueueKeep3rStealthJobInterface;
