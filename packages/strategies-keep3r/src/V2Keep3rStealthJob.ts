...
export interface V2Keep3rStealthJobInterface extends utils.Interface {
  functions: {
...
export interface V2Keep3rStealthJob extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: V2Keep3rStealthJobInterface;
