...
export interface V2Keep3rPublicJobInterface extends utils.Interface {
  functions: {
...
export interface V2Keep3rPublicJob extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: V2Keep3rPublicJobInterface;
