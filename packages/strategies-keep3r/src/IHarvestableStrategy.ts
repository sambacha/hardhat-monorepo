...
export interface IHarvestableStrategyInterface extends utils.Interface {
  functions: {
...
export interface IHarvestableStrategy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IHarvestableStrategyInterface;
