...
export interface CrvStrategyKeep3rJobInterface extends utils.Interface {
  functions: {
...
export interface CrvStrategyKeep3rJob extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CrvStrategyKeep3rJobInterface;
