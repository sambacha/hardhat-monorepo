...
export interface IStrategyKeep3rInterface extends utils.Interface {
  functions: {
...
export interface IStrategyKeep3r extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IStrategyKeep3rInterface;
