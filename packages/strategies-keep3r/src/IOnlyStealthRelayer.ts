...
export interface IOnlyStealthRelayerInterface extends utils.Interface {
  functions: {
...
export interface IOnlyStealthRelayer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IOnlyStealthRelayerInterface;
  ...
  functions: {
    ...
    ): Promise<[string] & { _stealthRelayer: string }>;
  };
