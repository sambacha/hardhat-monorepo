...
import type {
  V2Keep3rStealthJob,
  V2Keep3rStealthJobInterface,
} from "../V2Keep3rStealthJob";
...
export class V2Keep3rStealthJob__factory {
  static readonly abi = _abi;
  static createInterface(): V2Keep3rStealthJobInterface {
    return new utils.Interface(_abi) as V2Keep3rStealthJobInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): V2Keep3rStealthJob {
    return new Contract(address, _abi, signerOrProvider) as V2Keep3rStealthJob;
  }
}
