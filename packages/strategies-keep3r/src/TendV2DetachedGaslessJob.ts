...
export interface TendV2DetachedGaslessJobInterface extends utils.Interface {
  functions: {
...
export interface TendV2DetachedGaslessJob extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TendV2DetachedGaslessJobInterface;
