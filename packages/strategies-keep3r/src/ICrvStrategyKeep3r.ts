...
export interface ICrvStrategyKeep3rInterface extends utils.Interface {
  functions: {
    ...
    "isCrvStrategyKeep3r()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "isCrvStrategyKeep3r",
    values?: undefined
  ): string;
...
export interface ICrvStrategyKeep3r extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICrvStrategyKeep3rInterface;
  ...
  functions: {
    ...
    isCrvStrategyKeep3r(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    isCrvStrategyKeep3r(overrides?: CallOverrides): Promise<BigNumber>;
