...
export interface Keep3rV2OracleFactoryWrapperInterface extends utils.Interface {
  functions: {
    ...
    "keep3rV2OracleFactory()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "keep3rV2OracleFactory",
    values?: undefined
  ): string;
...
export interface Keep3rV2OracleFactoryWrapper extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Keep3rV2OracleFactoryWrapperInterface;
  ...
  functions: {
    ...
    keep3rV2OracleFactory(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    keep3rV2OracleFactory(overrides?: CallOverrides): Promise<BigNumber>;
