...
export class IV2DetachedJob__factory {
  static readonly abi = _abi;
  static createInterface(): IV2DetachedJobInterface {
    return new utils.Interface(_abi) as IV2DetachedJobInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IV2DetachedJob {
    return new Contract(address, _abi, signerOrProvider) as IV2DetachedJob;
  }
}
