...
export interface HarvestV2Keep3rStealthJobInterface extends utils.Interface {
  functions: {
...
export interface HarvestV2Keep3rStealthJob extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HarvestV2Keep3rStealthJobInterface;
