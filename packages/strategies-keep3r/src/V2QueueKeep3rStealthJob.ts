...
export interface V2QueueKeep3rStealthJobInterface extends utils.Interface {
  functions: {
    ...
    "strategyAmounts(address,uint256)": FunctionFragment;
    "strategyQueue(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "strategyAmounts",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "strategyQueue",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface V2QueueKeep3rStealthJob extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: V2QueueKeep3rStealthJobInterface;
