...
import type { V2DetachedJob, V2DetachedJobInterface } from "../V2DetachedJob";
...
export class V2DetachedJob__factory {
  static readonly abi = _abi;
  static createInterface(): V2DetachedJobInterface {
    return new utils.Interface(_abi) as V2DetachedJobInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): V2DetachedJob {
    return new Contract(address, _abi, signerOrProvider) as V2DetachedJob;
  }
}
