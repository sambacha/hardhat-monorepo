...
export interface HarvestV2DetachedJobInterface extends utils.Interface {
  functions: {
    ...
    "baseFeeOracle()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "baseFeeOracle",
    values?: undefined
  ): string;
...
export interface HarvestV2DetachedJob extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HarvestV2DetachedJobInterface;
  ...
  functions: {
    ...
    baseFeeOracle(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    baseFeeOracle(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    baseFeeOracle(overrides?: CallOverrides): Promise<PopulatedTransaction>;
