...
import type { V2Keep3rJob, V2Keep3rJobInterface } from "../V2Keep3rJob";
...
export class V2Keep3rJob__factory {
  static readonly abi = _abi;
  static createInterface(): V2Keep3rJobInterface {
    return new utils.Interface(_abi) as V2Keep3rJobInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): V2Keep3rJob {
    return new Contract(address, _abi, signerOrProvider) as V2Keep3rJob;
  }
}
