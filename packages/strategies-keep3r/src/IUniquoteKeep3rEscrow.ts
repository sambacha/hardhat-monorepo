...
export interface IUniquoteKeep3rEscrowInterface extends utils.Interface {
  functions: {
    "acceptGovernor()": FunctionFragment;
    "addLiquidityToJob()": FunctionFragment;
    "applyCreditToJob()": FunctionFragment;
    ...
    "removeLiquidityFromJob()": FunctionFragment;
    ...
    "unbondLiquidityFromJob()": FunctionFragment;
  };
...
export interface IUniquoteKeep3rEscrow extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IUniquoteKeep3rEscrowInterface;
  ...
  functions: {
    ...
    job(overrides?: CallOverrides): Promise<[string] & { _job: string }>;
  ...
  callStatic: {
    ...
    addLiquidityToJob(overrides?: CallOverrides): Promise<void>;

    applyCreditToJob(overrides?: CallOverrides): Promise<void>;
    ...
    removeLiquidityFromJob(overrides?: CallOverrides): Promise<void>;
    ...
    unbondLiquidityFromJob(overrides?: CallOverrides): Promise<void>;
  };
